  ...
  public void accept(SubscriptionRequested event) {
    ...
    String html =
            "<div style=\"font-family: Arial, sans-serif; max-width: 500px; padding: 20px;\">"
                    ...
                    + "<p>Vous êtes bien inscrit(e) au cours :</p>"
                    + "<div style=\"background: #f9f9f9; padding: 15px; border-radius: 5px; margin: 10px 0;\">"
                    + "<h3 style=\"margin: 0;\">" + course.getTitle() + "</h3>"
                    + "<p style=\"margin: 5px 0; color: #4CAF50;\"><strong>" + course.getPrice() + " €</strong></p>"
                    + "</div>"
                    + "<p><a href=\"" + pdfUrl + "\" style=\"color: #2196F3; font-weight: bold;\">"
